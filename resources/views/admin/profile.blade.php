        ...
        <div class="container">
            <div class="profile-area">
                <div class="main-profile">
                    ...
                    <a href="{{route('admin_password')}}" class="edit-profile">
                ...
                <div class="dz-list style-1">
                    <ul>
                        ...
                        <li>
                            <a href="{{route('admin_password')}}" class="item-content item-link">
                                <div class="dz-icon">
